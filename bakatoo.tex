...
\newline
Esiteks märgime, et igas ühemõõtmelises vektorruumis eksisteerib ortonormeeritud baas, sest kui $\left\lbrace b \right\rbrace$ on mingi baas, siis $\left\lbrace \frac{b}{\sqrt{b \cdot b}} \right\rbrace$ on ortonormeeritud baas.\\
...
sest siis $\{ e_1, e_2, \dots, e_{n-1}, \frac{a_n}{|a_n|}\}$ on ruumi $\mathbb{V}$ ortonormeeritud baas.\\
