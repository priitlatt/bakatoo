...
tööriistad Einstein'i erirelatiivsusteooria formuleerimiseks.

ajaloost: minkowski ruumi esmakordne kasutamine, poincare 
rühm...

Käesoelva bakalaureusetöö esimeseks eesmärgiks on 
tutvustada Minkowski aeg\-ruumi klassikalisi matemaatilisi 
omadusi pööramata liigselt tähelepanu nede füü\-sikalisele 
...
välja tuua asjaolu, et siin töös püüame pea kõik väited 
põhjendada matemaatilise aruteluga. Kuna teemakohane kirjandus 
...
tema füüsikaline sisu ongi äärmiselt loomulik, kuid range 
...
Bakalaureusetöö on referatiivne ja selle seimese poole aluseks 
on klassikuks kujunenud \cite{Naber}. Nimetatud monograafias
on enamik matemaatilist sisu omavaid tulemusi sõnastatud 
ülesannetenena või jõutud nendeni väga üldise arutelu tulemusel, 
siis oleme siin püüdnud neile tulemustele ka range tõestuse 
anda. Töö teise poole kirjutamiseks andis eelkõige 
inspiratsiooni \cite{Super}.
...
Nii blokkmaatriksid kui ma maatrikseksponentsiaal osutuvad väga 
praktilisteks tööriistadeks, vaata näiteks lause 
\ref{lause:rotation} või peatükk \ref{ptk:lie_ryhm} 
...
kriitilisema pilguga otrogonaalteisenduste omadusi ning 
keskendume neist vaid olulisimate uurimisele, mille 
tulemusena sõelume kõigi ortogonaalteisenduste rümast välja 
...
suhtes invariantsed. Peale Lorenzi teisenduste osutuvad 
...
läheb tarvis töö järgmistes osades. Lihtsamad tulemused, millele 
on pööratud tähelepanu kursustes Algebra I või Geomeetria II, 
esitame seejuures tõestusteta. 
...
Teoreemi 4.1 tõestuses antud algortimi ortonormeetirud baasi 
...
tavalise maatriksite korrutamise suhtes rühm. Järnevalt uurime 
...
Summary written in english here...

\newpage
\addcontentsline{toc}{section}{Kirjandus}
\bibliographystyle{alphaurl} %show the url's in references
