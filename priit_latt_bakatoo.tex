...
mis omavad väärtusi $1, \dots, n$, $n \in \N$, siis 
kirjutame 
\begin{align*}
...
Tuginedes aine Globaalanalüüs loengukonspektile \cite{globanal} 
anname järgnevas lühi\-kese (kuid samas käesoleva töö vajadusi silmas 
pidades\footnote{Vaata näiteks peatükk \ref{ptk:lie_ryhm}, 
\nameref{ptk:lie_ryhm}.} piisava) ülevaate diferentseeruva muutkonna 
mõistest.
...
Arvestades Pythagorase teoreemi kahemõõtmelisel tasandil, üldistame 
...
rühmad \cite[peatükk Poincar\'e algebra]{Super}. Et selle väite formaalne 
tõestamine nõuab palju tehnilist tööd ja tulemusi 
diferentsiaalgeomeetriast ning Lie algebrate teooriast, siis jätame 
siinkohal range tõestuse andmata ja piirdume vaid faktilise teadmisega.
...
tegelist on Lie rühmaga, siis see rühm on maatriksrühm.
...
vabamas vormis, mida Minkowski superruum endast kujutab ja kuidas on 
ta setud tavalise Minkowski aegruumiga. Alustuseks defineerime 
...
struktuurid. Analoogiliselt nagu me defineerisime supervektroruumi 
üldistame ka tavalise algebraga\footnote{
...
\bibliographystyle{alphaurl} %unsrturl
