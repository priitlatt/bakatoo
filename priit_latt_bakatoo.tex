...
on klassikuks kujunenud monograafia \cite{Naber}. Nimetatud monograafias
...
sest vastasel korral $b_n \nobreak \in \spn\{ b_1, b_2, \dots, b_{n-1}\}$, 
...
\V \colon\, \forall v \in  \mathbb{W} \text{ korral } 
...
\begin{equation*}
g \colon\, \V \times \V \rightarrow \R \text{, } 
...
leidmiseks, muutub teoreemi tõestus ilmseks (vt märkus 
...
$\psi \colon\, L \rightarrow \Lin V$ nimetatakse Lie algebra $L$ esituseks, 
