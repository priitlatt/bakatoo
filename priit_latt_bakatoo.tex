...
\begin{eqnarray*}
&&\left(\Lambda^{-1}\right)^T \eta \Lambda^{-1} = \left(\eta \Lambda^T \eta \right)^T \eta \left(\eta \Lambda^T \eta\right) = \\
&=&\left(\eta^T \left(\Lambda^T\right)^T \eta^T \right) \eta \eta \Lambda^T \eta = \eta \Lambda \eta \Lambda^T \eta = \eta \eta \eta = \eta.
\end{eqnarray*}
