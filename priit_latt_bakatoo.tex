...
Arvestades Pythagorase teoreemi kahemõõtmelisel tasandil toome sisse kauguse mõiste üldistatuna Minkowski aegruumile.
...
\begin{definitsioon}
Olgu $\Lambda \in \mathcal{L}_{GH}$ Lorentzi teisendus ja $n \in \Mat_{4, 1}\mathbb{R}$ nihketeisenduse maatriks. Kujutust $\mathcal{M} \ni x \mapsto \Lambda\indices{^a_b} x^b + n^b \in \mathcal{M}$ nimetatakse \emph{Poincar\'e teisenduseks\footnote{Vahel kasutatakse \emph{Poicar\'e teisenduse} asemel terminit \emph{Mittehomogeenne Lorentzi teisendus}.}} ja tähistatakse paarina $\{n, \Lambda\}$.
\end{definitsioon}
...
\end{align*}
koos tehtega $* : P \times P \rightarrow P,\ \{n_1, \Lambda_1\}*\{n_2, \Lambda_2\} \mapsto \{n_1 + \Lambda_1 n_2, \Lambda_1 \Lambda_2\}$, nimetame \emph{Poincar\'e rühmaks}, mida tähistatakse sümboliga $\mathcal{P}$.
\end{definitsioon}

Veendumaks Poincar\'e rühma defintsiooni korrektsuses piisab näidata, et hulk $P$ koos tehtega $* : P \times P \rightarrow P$ moodustab tõepoolest rühma.
...
\begin{align*}
\left(\{n_1, \Lambda_1\} \{n_2, \Lambda_2\}\right) \{n_3, \Lambda_3\} &= \{n_1 + \Lambda_1 n_2, \Lambda_1 \Lambda_2 \} \{n_3, \Lambda_3 \} = \\
...
= \{n_1, \Lambda_1 \} \{n_2 + \Lambda_2 n_3, \Lambda_2 \Lambda_3 \} &= \{n_1, \Lambda_1\} \left( \{n_2, \Lambda_2\} \{n_3, \Lambda_3\} \right)
\end{align*}
